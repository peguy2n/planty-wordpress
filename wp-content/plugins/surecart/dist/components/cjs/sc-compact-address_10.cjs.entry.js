...
const mutations = require('./mutations-aba55e44.js');
...
const mutations$1 = require('./mutations-f21ba115.js');
const index$3 = require('./index-5cbca075.js');
const getters = require('./getters-3730f1ed.js');
...
const ScOrderBumps = class {
  ...
  render() {
    var _a, _b, _c, _d, _e;
    if (!((_c = (_b = (_a = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.recommended_bumps) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.length)) {
      return null;
    }
    return (index.h("sc-form-control", { label: this.label || wp.i18n.__('Recommended', 'surecart'), help: this.help }, index.h("div", { class: "bumps__list", "aria-label": wp.i18n.__('Order bump summary', 'surecart') }, (((_e = (_d = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _d === void 0 ? void 0 : _d.recommended_bumps) === null || _e === void 0 ? void 0 : _e.data) || [])
